          ...
          <div className="max-w-2xl animate-fade-up lg:mr-auto">
            ...
            <div className="mt-10 pt-6 border-t border-neutral-200">
              ...
              <div className="flex flex-wrap gap-6 items-center opacity-70">
                <img 
                  src="https://upload.wikimedia.org/wikipedia/commons/3/3e/Tata_logo.svg" 
                  alt="Tata" 
                  className="h-6 object-contain"
                />
                <img 
                  src="https://upload.wikimedia.org/wikipedia/commons/8/89/Mahindra_%26_Mahindra-Logo.svg" 
                  alt="Mahindra" 
                  className="h-6 object-contain"
                />
                <img 
                  src="https://upload.wikimedia.org/wikipedia/commons/d/d9/Larsen_%26_Toubro_Logo.svg" 
                  alt="L&T" 
                  className="h-7 object-contain"
                />
                <img 
                  src="https://upload.wikimedia.org/wikipedia/commons/4/4c/Bharat_Heavy_Electricals_Limited_Logo.svg" 
                  alt="BHEL" 
